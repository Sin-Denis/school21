...
/*   Updated: 2019/08/17 12:52:32 by jblue-da         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/output.h"

static void road_handler1(t_graph *g, t_vector *road, t_pair *indexes, t_pair *distr_offset)
{
	int i;
	int j;
...
static void road_handler2(t_graph *g, t_vector *road, t_pair *indexes, t_pair *distr_offset)
{
	int i;
	int j;
...
static void road_handler3(t_graph *g, t_vector *road, t_pair *indexes, t_pair *distr_offset)
{
	int i;
	int j;
...
void road_handler(t_graph *g, t_vector *road, t_pair *indexes, t_pair *distr_offset)
{
